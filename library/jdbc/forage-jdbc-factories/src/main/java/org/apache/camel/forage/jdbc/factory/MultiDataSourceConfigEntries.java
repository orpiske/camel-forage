...
/**
 * Configuration entries for multi-DataSource factory with support for multiple named instances.
 */
public class MultiDataSourceConfigEntries extends ConfigEntries {
